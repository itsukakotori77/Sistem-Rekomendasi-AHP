            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card card-profile">
                        <div class="card-header" style="background-image: url('{{ asset('bootstrap-back/img/blogpost.jpg') }}')">
                            <div class="profile-picture">
                                <div class="avatar avatar-xl">
                                    @if($data->avatar != '')
                                        <img src="{{ asset('bootstrap-back/img/foto-user/' . $data->avatar ) }}" id="avatar" alt="..." class="avatar-img rounded-circle">
                                    @else 
                                        <img src="{{ asset('bootstrap-back/img/foto-user/user.png') }}" id="avatar" alt="..." class="avatar-img rounded-circle">
                                    @endif
                                </div>
                            </div>
                        </div>
...
@section('js')
    ...
    <script>
        ...
        @if(session('Status'))
            ...
            content.message = 'Data Profile telah diubah';
