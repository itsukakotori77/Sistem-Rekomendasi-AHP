            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="container">
                                <form action="{{ url('/pengurus') }}" id="formPengurus" method="POST" enctype="multipart/form-data" autocomplete="off"> 
                                    {{ csrf_field() }}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control only-string" required id="Nama_Depan" name="Nama_Depan" placeholder="Nama Depan">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control only-string" required id="Nama_Belakang" name="Nama_Belakang" placeholder="Nama Belakang">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="Alamat" class="form-control" required id="Alamat" cols="30" rows="5" placeholder="Alamat"></textarea>
                                    </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="text-center">
                                                    <img class="product" id="avatar" width="300" height="250">          
                                                </div>
                                            </div>
                                        </div>
                                    </div>
